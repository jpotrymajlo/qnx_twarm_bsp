...
#define CAM_MODULE_SIM		0x04          /* target sim */
#define CAM_MODULE_BLK		0x08          /* target ioblk */
#define CAM_MODULE_FSYS		0x10          /* target filesystem */
...
/* __SRCVERSION("$IQ: dcmd_cam.h,v 1.23 $"); */
