...
#define DIB_DIRTY		0x04
	...
	ulong_t		disc_identification;
	ulong_t		session_lead_in;
	ulong_t		session_lead_out;
	ulong_t		disc_bar_code;
	uchar_t		rsvd32;
...
#define RPD_BPU		0x04		// block position unknown
	...
	uchar_t		rsvd2;
	uchar_t		rsvd3;
	ulong_t		first_block_location;
	ulong_t		last_block_location;
	uchar_t		rsvd12;
	uchar_t		number_blocks_buffer[3];
	ulong_t		number_bytes_buffer;
