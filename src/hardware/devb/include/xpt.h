...
#define XPT_XFLAG_VERIFY				0x0002
#define XPT_XFLAG_PNP					0x0004
#define XPT_XFLAG_ENUMERATING			0x0008
#define XPT_XFLAG_SMART_CACHE			0x0010
#define XPT_XFLAG_RESMGR				0x0020
#define XPT_XFLAG_DISP_CCB_INTERNAL		0x0040
#define XPT_XFLAG_DISP_CCB_EXTERNAL		0x0080
#define XPT_XFLAG_IO_DONE				0x0100
...
#define CAM_VU_FLAG_PTHRU           0x01    /* flag says pass through ccb */
#define CAM_VU_FLAG_RETRY			0x02
...
#define CAM_VUHBA_RESVD1			1		/* For extended flags in the future */
...
#define CAM_VUHBA_EFLAGS			10		/* offset for extended flags */
